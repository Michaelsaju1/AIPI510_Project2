...
# The Azure Effect: Measuring the Jump in Clean Energy Production in Regions That Host Microsoft's Data Centers
...
# Project Structure
├── Statistical_analysis.py             # Python code file 
...
1. Clone the Repository git clone https://github.com/Michaelsaju1/AIPI510_Project2.git  
